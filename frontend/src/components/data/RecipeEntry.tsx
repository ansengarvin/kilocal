        ...
        <>
            <RecipeEntryRow>
                ...
                <td className="calories">
                    <div className="recipeInfo">{testTotalCal}</div>
                </td>
                <td className="carbs">
                    <div className="recipeInfo">{testTotalCarbs}</div>
                </td>
                <td className="protein">
                    <div className="recipeInfo">{testTotalProtein}</div>
                </td>
                <td className="fat">
                    <div className="recipeInfo">0</div>
                </td>
